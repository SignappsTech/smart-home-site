...
export const featuresContent = {
  intro:
    "Pametni dom ni le ena naprava — je povezan sistem, ki poskrbi za udobje, varnost in nižjo porabo. Tukaj je nekaj najpogostejših scenarijev, ki jih postavimo za vas.",
  ...
  dashboard: {
    ...
    text: "Namesto golega, tehničnega vmesnika dobite čisto, oblikovano nadzorno ploščo, ki jo zna uporabljati vsa družina. Vsaka naprava ima svojo kartico glede na tip — luči, senzorji, ogrevanje, kamere — razporeditev pa prosto urejate sami.",
    points: [
